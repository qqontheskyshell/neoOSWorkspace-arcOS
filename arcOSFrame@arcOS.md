...
arcOSenigma@arcOS > + 
+enigmaKey="1"
+findMy(enigmaKey) > visualDrone@arcOS is On + livespeak is On + neoSearch"enigmaKey" > + "arcOSQQLocalTarget" > +if they have criminal intention then loop@arcOS > + male > loop@arcOS + arcOSRFModules "lowestRF"  + deathnote $QQLOCAL > male + strikeKit@arcOS + BlackKumaTargetLib@arcOS/
