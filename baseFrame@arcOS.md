...
```bash
#kumaShell
kumaShell@arcOS > +SIMULATOR_UDID > baseFrame@arcOS + disableIphoneSimulator + SIMULATOR_UDID="AAAAAAAA-BBBB-CCCC-DDDD-EEEEEEEEEEEE" + xcrun simctl shutdown "$SIMULATOR_UDID" + xcrun simctl erase "$SIMULATOR_UDID" + xcrun simctl shutdown all + xcrun simctl erase all + xcrun simctl shutdown all + xcrun simctl delete unavailable
