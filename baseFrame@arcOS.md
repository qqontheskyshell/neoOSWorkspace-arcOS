...
#kumaShell
kumaShell@arcOS > + 
+kanchinConfigTarget > + kanchinConfig@arcOS + every packet routing into main leader in their kanchinConfigTarget and its coreTelephony > + randomize baseNet@arcOS on them/
